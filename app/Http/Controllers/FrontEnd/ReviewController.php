...
class ReviewController extends Controller
{
    public function add($product_slug){
        ...
        if($product)
        {
            ...
            return view('frontend.reviews.index', compact('product', 'verified_purchase')); 
                ...
                return redirect()->back()->with('status', "Este link esta fallido");
        }
    ...
    public function create(Request $request){
        ...
        if($product)
        {
            ...
            if($new_review)
            {
                return redirect('category/'.$category_slug.'/'.$prod_slug)->with('status', "Gracias por la reseña");
            }
        }
        else{
            return redirect()->back()->with('status', "Este link esta fallido");
    ...
    public function edit($product_slug)
    {
        ...
        if($product)
        {
            ...
            return redirect()->back()->with('status', "Este link esta mal");
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        if($user_review != '')
        {
            ...
            if($review)
            {
                ...
                $review->update();
                return redirect('category/'.$review->product->category->slug.'/'.$review->product->slug)->with('status', "Reseña actualizada");
            }
            else{
                return redirect()->back()->with('status', "Este link esta mal");
            }
            ...
            return redirect()->back()->with('status', "No puedes reseñar");
        }
    }
