        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header bg-danger">
                    <h4>Entregas
                        <a href="<?php echo e(url('orders')); ?>" class="btn btn-warning text-white float-end">Nueva orden</a>
                    </h4>
                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GTIM\Desktop\VERSION BETA\ALFA\pincerolas\resources\views/admin/orders/history.blade.php ENDPATH**/ ?>