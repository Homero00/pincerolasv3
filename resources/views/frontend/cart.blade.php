        ...
        <div class="card shadow">
            ...
            @php $total = 0; @endphp
                ...
                <div class="row product_data">
                    <div class="col-md-2 my-auto">
                        <img src="{{ asset('assets/uploads/products/'.$item->products->image) }}" heigth="70px"
                    ...
                    <div class="col-md-2 my-auto">
                        <h6>MXN {{ $item->products->selling_price }}</h6>
                    </div>
                    <div class="col-md-3 my-auto">
            ...
            <div class="card-footer">
                ...
                <div class="card-body texte-center">
                    ...
                    <a href="{{ url('category') }}" class="btn btn-outline-primary float-end">Ir a comprar</a>  
                </div>
                @endif
        </div>
    </div>
