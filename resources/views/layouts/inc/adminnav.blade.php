...
<a href="{{ url('add_category') }}">Añadir Categoria </a>
<a href="{{ url('products') }}">Productos </a>
<a href="{{ url('add-products') }}">Añadir productos </a>
<a href="{{ url('orders') }}">Ventas </a>
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="../pages/sign-in.html" class="nav-link text-body font-weight-bold px-0">
                ...
                <a class="d-sm-inline d-none"  href="{{ route('logout') }}"   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
          {{ __('SALIR') }}</a>
