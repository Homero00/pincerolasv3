...
<nav class="navbar navbar-expand-lg"  style="background-color: #FF4B4B;">
  <div class="container">
    <a class="navbar-brand" href="{{ url('/') }}">  <img src="{{asset('assets/images/logo.png')}}" alt="devctheme Logo" width="200" height="200"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto">
        ...
        <li>
            <a class="nav-link active" href="{{ url('category') }}">Categorias</a>
        </li>
        <li>
            <a class="nav-link active" href="{{ url('cart') }}">Carrrito
               <span class="badge badge-pill bg-primary cart-count">0</span></a>
                        ...
                        @guest
                                ...
                                @if (Route::has('register'))
                                        ...
                                        <a class="nav-link active" href="{{ route('register') }}">{{ __('Resgistrate') }}</a>
                            ...
                            <div class="dropdown">
                                  <button class="btn btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu">
                                      <li> <a href="{{ url('my-orders') }}" class="dropdown-item hr">Mi historial</a></li>
                                      <li>
                                        
                                      </li>
                                      <li>
                                          <a  href="{{ route('logout') }}"  class="dropdown-item hr" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                          {{ __('Cerrar Sesión') }}</a>
